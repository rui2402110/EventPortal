...
<head>
  ...
  <title>イベントポータル - 参加者ログイン</title>
</head>
<body>
  <div class="container">
    <div class="header" id="screen_title">
      <div class="role-label">参加者</div>
      イベントポータル
    </div>

    <div class="content">
      <form method="post" action="${pageContext.request.contextPath}/eventportal/auth/EntryLoginExecute.action">

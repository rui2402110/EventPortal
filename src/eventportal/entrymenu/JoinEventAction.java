    ...
    public void execute(HttpServletRequest req, HttpServletResponse res) throws Exception {
        ...
        try {
            ...
            if (existingTicket != null) {
                ...
                req.setAttribute("message", "既にこのイベントに参加登録済みです。");
            ...
            if (count > 0) {
                ...
                // イベント詳細画面にリダイレクト
                res.sendRedirect(req.getContextPath() + "/eventportal/entrymenu/EntryEventDetail.action?eventId=" + eventId + "&joined=true");
            } else {
    ...
    private String generateTicketId() throws Exception {
        ...
        try {
            ...
            if (resultSet.next()) {
                ...
                String numberPart = lastTicketId.substring(3); // "TKT" の後の部分
                nextNumber = Integer.parseInt(numberPart) + 1;
            }

            // TKT + 5桁の数字（例: TKT00001, TKT00002）
